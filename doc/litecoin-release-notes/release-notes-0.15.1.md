Apiocoin Core version *0.15.1* is now available from:

  <https://download.apiocoin.org/apiocoin-0.15.1/>
...
A number of changes to the way Apiocoin Core deals with peer connections and invalid blocks
