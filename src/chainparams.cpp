...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.apiocoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.apiocointools.com");
        vSeeds.emplace_back("dnsseed.apiocoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.apiocointools.com");
        vSeeds.emplace_back("seed-b.apiocoin.loshan.co.uk");
